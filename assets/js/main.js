...
function sendMail() {
    ...
    const serviceID = "service_vnzxgim";
    const templateID = "template_at8z9y7";
...
(function () {
    emailjs.init("SBaBcps172GWBL0yF");
})();
...
var typed = new Typed(".auto-type", {
    strings: ["Your Web Development Experts", "Kondapaneni Pavan Kumar", "Garapati Pavan Kumar"],
    typeSpeed: 80,
    backSpeed: 50,
    loop: true
})
